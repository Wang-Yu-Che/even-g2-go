...
func TestBuildEvenHubNativeGoldens(t *testing.T) {
	tests := []struct {
		...
		{"create list", func() ([]byte, error) { return BuildEvenHubCreateList("hud", []string{"one", ""}, 201) }, []byte{0x10, 0xC9, 0x01, 0x1A, 0x25, 0x08, 0x01, 0x12, 0x1E, 0x18, 0xC0, 0x04, 0x20, 0xA0, 0x02, 0x48, 0x01, 0x52, 0x03, 'h', 'u', 'd', 0x5A, 0x0D, 0x08, 0x02, 0x18, 0x01, 0x22, 0x03, 'o', 'n', 'e', 0x22, 0x02, 0xC2, 0xB7, 0x60, 0x01, 0x28, 0x90, 0x4E}},
